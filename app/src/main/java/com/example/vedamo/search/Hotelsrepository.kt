...
/**
 * Hotels.com — real integration requires an approved affiliate/partner
 * account with Hotels.com (Expedia Partner Solutions (EPS), same program as Expedia), which Vedamo does not
 ...
 *    Hotels.com's documented search endpoint.
 ...
 *    ProviderOfferResult.
 */
class HotelsRepository : ProviderRepository {
    override val providerName: String = "Hotels.com"
    ...
    override suspend fun fetchOffer(context: HotelSearchContext): ProviderOfferResult {
        ...
        return ProviderOfferResult.Unavailable(
            "No authorized Hotels.com API access configured yet"
        )
    }
}